            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="about-us text-center wow fadeInDown">
                        <img src="<?php echo bloginfo('template_url'); ?>/img/about.png" alt="About Us" class="img-responsive">
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div id="testimonial">
                            ...
                            <div class="tst-item clearfix">
                                <div class="tst-single clearfix">
                                    <img src="<?php echo bloginfo('template_url'); ?>/img/client/1.jpg" alt="Client" class="img-circle">
                                ...
                                <div class="tst-single clearfix">
                                    <img src="<?php echo bloginfo('template_url'); ?>/img/client/2.jpg" alt="Client" class="img-circle">
                                    <div class="tst-content">
                                        <p>Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem. Mauris blandit aliquet elit, eget tincidunt.</p>
                                        <span>John Doe,CEO</span>
                                    </div>
                            ...
                            <div class="tst-item">
                                <div class="tst-single clearfix">
                                    <img src="<?php echo bloginfo('template_url'); ?>/img/client/3.jpg" alt="Client" class="img-circle">
                                    <div class="tst-content">
                                        <p>Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem. Mauris blandit aliquet elit, eget tincidunt.</p>
                                        <span>John Doe,CEO</span>
                                    </div>
