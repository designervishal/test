...
<!--[if gt IE 8]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    <head>
        ...
        <!-- Fancybox -->
        <link rel="stylesheet" href="<?php echo bloginfo('template_url'); ?>/css/jquery.fancybox.css">
        <!-- owl carousel -->
        ...
        <!-- Main Responsive -->
        <link rel="stylesheet" href="<?php echo bloginfo('template_url'); ?>/css/responsive.css">
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <h1 class="navbar-brand">
                        <a href="#body">
                            <img src="<?php echo bloginfo('template_url'); ?>/img/logo.png" alt="Kasper Logo">
                        </a>
                    </h1>
                    <!-- /logo -->
        ...
        <section id="home">     
            <div id="home-carousel" class="carousel slide" data-interval="false">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="item active"  style="background-image: url('<?php echo bloginfo('template_url'); ?>/img/slider/bg2.jpg');">
                    ...
                    <div class="item" style="background-image: url('<?php echo bloginfo('template_url'); ?>/img/slider/bg2.jpg')">                
                        <div class="carousel-caption">
                    ...
                    <div class="item" style="background-image: url('<?php echo bloginfo('template_url'); ?>/img/slider/bg3.jpg')">                 
                         <div class="carousel-caption">
